...
###
#save(sce,file="sce cells5   features300 读取进来后所有数据 counts数据合并后.Rdata")   #The SCE data after GSE194315 analysis is too large to upload, so it needs to be downloaded from the GEO official website and analyzed step by step according to the code.
